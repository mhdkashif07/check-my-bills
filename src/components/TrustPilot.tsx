  ...
  return (
    <div className="bg-gray-100">
      <section className="py-10 px-18 max-w-7xl mx-auto ">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-2 mt-1">
        ...
        <div className="flex flex-col  items-center p-6 shadow- md w-full max-w-xs  mx-auto text-center ">
          ...
          <div className="mt-2 flex justify-center md:px-8">
            <Image
              src="/trustpilot.png"
              alt="4.5 stars"
        ...
        <div
          className="trustpilot-widget mt-1"
          data-locale="en-GB"
