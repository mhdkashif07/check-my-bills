...
const Footer = () => {
  return (
    <footer className="w-full text-[14px]">
      <div className="bg-[#042e63b3] text-white pt-[5.4rem] pb-[6.17rem] px-4 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="text-base">
                <p className=""><span className='font-semibold'>Checkmybills.co.uk</span> 
              is registered trademark of Platform 101 L
              company No. 15681880 Registe
              address 27 Old Gloucester Stre
              London, WC1N 3
              Checkmybills.co.uk is trading st
              of Platform 101 Ltd. © 2025 
                Rights Reserved.</p>
              </div>
            </div>
  ...
  >
    ...
    >
      ...
      {/* Copyright Bar */}
      <div className="bg-[#061c20] text-gray-400 py-[1.91rem] text-center text-sm">
        Copyright © 2025{" "}
